 ...
 * https://ift2015h20.code.blog/2020/01/15/devoir-1-comment-dessiner-un-arbre/#more-150
...
public class Plotter {
    ...
    private void parseLSystem(JSONObject params) throws Exception {
        ...
        /*
         * autres paramètres pour lsystem: lsystem.addSymbol, lsystem.setAction,
         * lsystem.addRule
         */
    }
    ...
    private void allezallez(String[] args) throws Exception {
        ...
        if (arg_idx == args.length)
            throw new IllegalArgumentException("Give JSON file name as command-line argument: java ... "
                    + getClass().getName() + " lsystem.json niter");
        String json_file = args[arg_idx++];
        if (arg_idx == args.length)
            throw new IllegalArgumentException(
                    "Give number of rewriting iterations as the last command-line argument: java ... "
                            + getClass().getName() + " lsystem.json niter");
