...
/**
 * Turtle graphics interface. The turtle state is defined as its location on the
 * plane and the orientation of its nose. Implementing classes are expected to
 * initialize the turtle with position (0,0) and angle 0 by default. The turtle
 * moves and draws by unit-length steps, and turns left or right by a unit angle
